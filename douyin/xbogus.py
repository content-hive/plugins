# ==============================================================================
# Adapted from the Douyin_TikTok_Download_API project by Evil0ctal.
...
def sign_url(url: str, user_agent: Optional[str] = None) -> Tuple[str, str, str]:
    """Sign a Douyin API URL with X-Bogus parameter.

    Args:
        url: The full API URL including query string (without X-Bogus).
        user_agent: Optional User-Agent string. Defaults to a Chrome UA.

    Returns:
        Tuple of (signed_url, x_bogus_value, user_agent_used).
    """
