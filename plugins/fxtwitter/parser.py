...
from .const import API_BASE_URL, DOMAIN, PLATFORM_CODE, PLATFORM_ICON, PLATFORM_NAME, PLATFORM_URL, URL_PATTERN
...
class FXTwitterParser:
    ...
    async def async_setup(self):
        ...
        try:
            ...
            self.context.logger.exception("Failed to initialize parser")
    ...
    def _convert_to_api_url(self, url: str) -> str:
        ...
        return url.replace("twitter.com", API_BASE_URL).replace("x.com", API_BASE_URL)
